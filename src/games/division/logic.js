...
export const DIVISOR_RULES = [
  ...
  { n: 4, rule: '2 הספרות הימניות מתחלקות ב-4', example: '6524' },
  { n: 5, rule: 'ספרת האחדות 0 או 5', example: '330, 2745' },
  { n: 6, rule: 'המספר מתחלק גם ב-2 וגם ב-3', example: '162' },
  { n: 8, rule: '3 הספרות הימניות מתחלקות ב-8', example: '320' },
  { n: 9, rule: 'סכום הספרות מתחלק ב-9', example: '3765' },
  { n: 10, rule: 'ספרת האחדות 0', example: '230' },
  {
    n: 11,
    rule: '2 הספרות השמאליות פחות הספרה הימנית מתחלק ב-11 (715 ← 71−5=66); לחלופין, סכום הספרות החיצוניות פחות הספרה הפנימית שווה ל-0 או 11 (132 ← 1+2−3=0)',
    example: '715, 132',
  },
]
