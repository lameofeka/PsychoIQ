...
const LAW_RULES = [
  {
    ...
    lines: [
      ...
      'מספר א"ז של מינוסים ← התוצאה שלילית (-)',
      '(+)·(+) = (-)·(-) = (+)',
      '(+)·(-) = (-)·(+) = (-)',
      '(+)÷(-) = (-)÷(+) = (-)',
    ],
  },
  {
    ...
    title: 'זוגי וא"ז',
    lines: [
      'בחיבור/חיסור סופרים כמה מהאיברים הם א"ז:',
      'מספר א"ז של איברים א"ז ← התוצאה א"ז',
      'מספר זוגי של איברים א"ז ← התוצאה זוגי',
      'זוגי ± זוגי = זוגי  ·  א"ז ± א"ז = זוגי  ·  זוגי ± א"ז = א"ז',
      'בכפל: אם גורם אחד זוגי - כל המכפלה זוגית',
      'זוגי × זוגי = זוגי  ·  א"ז × א"ז = א"ז  ·  א"ז × זוגי = זוגי',
    ],
  },
]
