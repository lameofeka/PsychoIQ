...
const LAW_OPTIONS = [
  ...
  { value: LAWS.PARITY, label: 'זוגי / א"ז', icon: '≡' },
  { value: LAWS.FRACTION, label: 'חילוק ושברים', icon: '½' },
  { value: LAWS.PRODUCTS, label: 'מכפלות מיוחדות', icon: '∏' },
]

const LAW_DESCRIPTIONS = {
  [LAWS.SIGN]: 'כמה פלוס ומינוס יש בכפל או בחילוק? מספר זוגי של מינוסים - תוצאה חיובית, מספר א"ז של מינוסים - תוצאה שלילית.',
  [LAWS.PARITY]: 'זוגי וא"ז בחיבור, בחיסור ובכפל - השלימו את התוצאה או את המספר החסר.',
